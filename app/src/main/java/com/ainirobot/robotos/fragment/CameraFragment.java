...
public class CameraFragment extends BaseFragment implements CameraView.OnImageCapturedListener, CameraView.OnVideoCapturedListener, CameraView.OnCameraStateChangedListener {
    ...
    private final CameraFragment.ProgressBarAnimator mAnimator = new CameraFragment.ProgressBarAnimator();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        mCameraHolder = view.findViewById(com.xlythe.view.camera.R.id.layout_camera);
        mPermissionPrompt = view.findViewById(com.xlythe.view.camera.R.id.layout_permissions);
        mPermissionRequest = view.findViewById(com.xlythe.view.camera.R.id.request_permissions);
        mCamera = view.findViewById(com.xlythe.view.camera.R.id.camera);
        mToggle = view.findViewById(com.xlythe.view.camera.R.id.toggle);
        mCapture = mCameraHolder.findViewById(com.xlythe.view.camera.R.id.capture);
        mProgress = view.findViewById(com.xlythe.view.camera.R.id.progress);
        mDuration = view.findViewById(com.xlythe.view.camera.R.id.duration);
        mCancel = view.findViewById(com.xlythe.view.camera.R.id.cancel);
        mConfirm = view.findViewById(com.xlythe.view.camera.R.id.confirm);
    ...
    private void invalidate() {
        ...
        if (mCapture != null) {
            mCapture.setOnTouchListener(new CameraFragment.OnTouchListener(getContext()));
        }
